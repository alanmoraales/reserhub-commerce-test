...
export function Environment(name: string): BaseURL {
    return `https://${name}-nmmrw.encr.app`
}
...
/**
 * Client is an API client for the nmmrw Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "nmmrw-Generated-TS-Client (Encore/v1.46.4)";
        }
