...
export function Environment(name: string): BaseURL {
    return `https://${name}-z5rui.encr.app`
}
...
/**
 * Client is an API client for the z5rui Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "z5rui-Generated-TS-Client (Encore/v1.46.5)";
        }
